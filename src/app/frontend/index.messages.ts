...
export const BREADCRUMBS: IBreadcrumbMessage = {
  ...
  [IBreadcrumbMessageKey.Mesh]: $localize`Mesh`,
  ...
  [IBreadcrumbMessageKey.Meshs]: $localize`Meshs`,
  [IBreadcrumbMessageKey.Config]: $localize`Config`,
  [IBreadcrumbMessageKey.Trace]: $localize`Trace`,
